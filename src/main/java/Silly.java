...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object from two strings.
     * The name of the new Silly object will be the concatenation of the two arguments.
     *
     * @param nameHead the first part of this Silly instance's name.
     * @param nameTail the second part of this Silly instance's name.
     */
    public Silly(String nameHead, String nameTail){
        this.name = nameHead + nameTail;
    }
